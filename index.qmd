...
**Convergence**
Repeat until $\left| \sum w - \text{Target} \right| < \epsilon$.
...
$$
\noindent
where $P_{ijr}$ is the cumulative probability for variable $i$ at level $j$ and rank $r$. The mean rank is
$$
